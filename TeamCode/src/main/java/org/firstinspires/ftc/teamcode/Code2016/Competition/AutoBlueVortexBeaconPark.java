 ...
 */
@Autonomous(name = "AutoBlueVortexBeaconPark", group = "Autonomous")
@Disabled
public class AutoBlueVortexBeaconPark extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        shooterleft = hardwareMap.dcMotor.get("sweeper");
        shooterright = hardwareMap.dcMotor.get("conveyor");
        ...
        while (opModeIsActive() && gyro.getHeading()<15 ){
        ...
        runwithoutencoders();
        while(opModeIsActive() && gyro.getHeading()<75){
            rightbackdrive.setPower(-0.2);
            rightfrontdrive.setPower(-0.2);
        }
        stopmotors();
        ...
        while (opModeIsActive() && ODS.getLightDetected()>0.07){
            drive(-0.2);
        }
        ...
        resetDriveEncoders();
        runwithoutencoders();
        while (opModeIsActive() && gyro.getHeading() < 137){
            leftbackdrive.setPower(0.2);
            leftfrontdrive.setPower(0.2);
        }
        stopmotors();
