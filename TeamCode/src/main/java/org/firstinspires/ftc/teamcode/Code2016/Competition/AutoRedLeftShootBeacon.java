...
/**
 * Created by stevenelias on 11/15/16.
 */
@Autonomous(name = "AutoRedLeftShootBeacon", group = "Autonomous")
@Disabled
public class AutoRedLeftShootBeacon extends LinearOpMode {
    //Button left stop position is 0.5244
    ...
    public void runOpMode() throws InterruptedException {
        ...
        runwithoutencoders();
        while(opModeIsActive() && gyro.getIntegratedZValue()<30){
            turnleft(0.2);
        }
        stopmotors();
        runwithoutencoders();
        ...
        */
        ...
        gyro.resetZAxisIntegrator();
        sleep(500);
        while (opModeIsActive() && gyro.getIntegratedZValue()<35){
            turnleft(0.2);
        }
        stopmotors();
        runwithoutencoders();
        ...
        while (opModeIsActive() && gyro.getIntegratedZValue()>-82
                ){
            turnright(0.2);
        }
        stopmotors();
        ...
        gyro.resetZAxisIntegrator();
        sleep(500);
        while (opModeIsActive() && gyro.getIntegratedZValue()<78){
            turnleft(0.2);
        }
        stopmotors();
        runwithoutencoders();
