 ...
 */
@Autonomous(name = "AutoBlueShootBeaconFinal", group = "Autonomous")
public class AutoBlueShootBeaconFinal extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
       ...
       /////////////
        ...
        ///////////
        runwithoutencoders();
        while (opModeIsActive() && gyro.getIntegratedZValue()>-81){
            turnright(0.2);
        }
        stopmotors();
        //////////
...
////////////////
        ...
        /////////////
        runwithoutencoders();
        while (opModeIsActive() && gyro.getIntegratedZValue()>-83){
            turnright(0.2);
        }
        stopmotors();
        resetdriveencoders();
...
////////////
        runwithoutencoders();
        while (opModeIsActive() && gyro.getIntegratedZValue()>-79){
            turnright(0.2);
        }
        stopmotors();
...
////////////////
        ...
        drive(-0.2);
        sleep(250);
        while (opModeIsActive() && gyro.getIntegratedZValue()<-50){
            turnleft(0.2);
        }
        stopmotors();
        runwithoutencoders();
