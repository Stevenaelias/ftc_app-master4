 ...
 */
@Autonomous(name = "AutoBlueOuterShootBeacon", group = "Autonomous")
@Disabled
public class AutoBlueOuterShootBeacon extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        ///////////
        runwithoutencoders();
        while (opModeIsActive() && gyro.getIntegratedZValue()>-80){
            turnright(0.2);
        }
        stopmotors();
        //////////
        runwithoutencoders();
        while (opModeIsActive() && Range.getDistance(DistanceUnit.MM)>50){
            drive(0.2);
        }
        stopmotors();
////////////////
